...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-white dark:bg-gray-800 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('contactMe')}</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">{t('contactText')}</p>
